...
var ReedSolomonDecoder = /** @class */ (function () {
    ...
    ReedSolomonDecoder.prototype.decode = function (received, twoS) {
        var poly = new gf256_1.GF256Poly(this.field, received);
        ...
        var syndrome = new gf256_1.GF256Poly(this.field, syndromeCoefficients);
        ...
        for (var i = 0; i < errorLocations.length; i++) {
            ...
            received[position] = gf256_1.GF256.addOrSubtract(received[position], errorMagnitudes[i]);
        }
    };
    ...
    ReedSolomonDecoder.prototype.findErrorMagnitudes = function (errorEvaluator, errorLocations, dataMatrix) {
        ...
        for (var i = 0; i < s; i++) {
            ...
            for (var j = 0; j < s; j++) {
                if (i != j) {
                    denominator = this.field.multiply(denominator, gf256_1.GF256.addOrSubtract(1, this.field.multiply(errorLocations[j], xiInverse)));
                }
            }
