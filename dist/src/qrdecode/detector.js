...
*/
var alignpat_1 = require("./alignpat");
...
var Detector = /** @class */ (function () {
    function Detector(image, rawImage, width, height) {
        ...
        this.findAlignmentInRegion = function (overallEstModuleSize, estAlignmentX, estAlignmentY, allowanceFactor) {
            ...
            var alignmentFinder = new alignpat_1.AlignmentPatternFinder(this.image, alignmentAreaLeftX, alignmentAreaTopY, alignmentAreaRightX - alignmentAreaLeftX, alignmentAreaBottomY - alignmentAreaTopY, overallEstModuleSize, this.width, this.height, this.resultPointCallback);
        ...
        this.sampleGrid = function (image, transform, dimension) {
            var sampler = new grid_1.GridSampler(this.width, this.height);
            return sampler.sampleGrid3(image, this.rawImage, dimension, transform);
        };
        this.detect = function () {
            var info = new findpat_1.FinderPatternFinder(this.width, this.height).findFinderPattern(this.image);
    ...
    Detector.prototype.processFinderPatternInfo = function (info) {
        ...
        var provisionalVersion = version_1.Version.getProvisionalVersionForDimension(dimension);
