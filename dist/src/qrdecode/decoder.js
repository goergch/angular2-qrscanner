...
*/
var rsdecoder_1 = require("./rsdecoder");
...
var Decoder = /** @class */ (function () {
    function Decoder() {
        ...
        this.decode = function (bits) {
            var parser = new bmparser_1.BitMatrixParser(bits);
            var version = parser.readVersion();
            var ecLevel = parser.readFormatInformation().ErrorCorrectionLevel;
            // Read codewords
            var codewords = parser.readCodewords();
            // Separate into data blocks
            var dataBlocks = datablock_1.DataBlock.getDataBlocks(codewords, version, ecLevel);
            ...
            var reader = new databr_1.QRCodeDataBlockReader(resultBytes, version.VersionNumber, ecLevel.Bits);
            return reader;
